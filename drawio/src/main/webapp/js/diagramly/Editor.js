...
(function () {
  ...
  Editor.styles = [
    ...
    { commonStyle: { fontColor: "#095C86", strokeColor: "#AF45ED", fillColor: "#F694C1" }, edgeStyle: { strokeColor: "#60E696" } },
    ...
    { commonStyle: { fontColor: "#1D3557", strokeColor: "#457B9D", fillColor: "#A8DADC" }, graph: { background: "#F1FAEE" } },
    { commonStyle: { fontColor: "#393C56", strokeColor: "#E07A5F", fillColor: "#F2CC8F" }, graph: { background: "#F4F1DE", gridColor: "#D4D0C0" } },
    { commonStyle: { fontColor: "#143642", strokeColor: "#0F8B8D", fillColor: "#FAE5C7" }, edgeStyle: { strokeColor: "#A8201A" }, graph: { background: "#DAD2D8", gridColor: "#ABA4A9" } },
    { commonStyle: { fontColor: "#FEFAE0", strokeColor: "#DDA15E", fillColor: "#BC6C25" }, graph: { background: "#283618", gridColor: "#48632C" } },
    { commonStyle: { fontColor: "#E4FDE1", strokeColor: "#028090", fillColor: "#F45B69" }, graph: { background: "#114B5F", gridColor: "#0B3240" } },
    {},
    { vertexStyle: { strokeColor: "#D0CEE2", fillColor: "#FAD9D5" }, edgeStyle: { strokeColor: "#09555B" }, commonStyle: { fontColor: "#1A1A1A" } },
    { vertexStyle: { strokeColor: "#BAC8D3", fillColor: "#09555B", fontColor: "#EEEEEE" }, edgeStyle: { strokeColor: "#0B4D6A" } },
    { vertexStyle: { strokeColor: "#D0CEE2", fillColor: "#5D7F99" }, edgeStyle: { strokeColor: "#736CA8" }, commonStyle: { fontColor: "#1A1A1A" } },
    { vertexStyle: { strokeColor: "#FFFFFF", fillColor: "#182E3E", fontColor: "#FFFFFF" }, edgeStyle: { strokeColor: "#23445D" }, graph: { background: "#FCE7CD", gridColor: "#CFBDA8" } },
    {
    ...
    { vertexStyle: { strokeColor: "#909090", fillColor: "#F5AB50" }, edgeStyle: { strokeColor: "#182E3E" }, commonStyle: { fontColor: "#1A1A1A" }, graph: { background: "#EEEEEE" } },
    { vertexStyle: { strokeColor: "#EEEEEE", fillColor: "#56517E", fontColor: "#FFFFFF" }, edgeStyle: { strokeColor: "#182E3E" }, graph: { background: "#FAD9D5", gridColor: "#BFA6A3" } },
    {
  ...
  Editor.enableServiceWorker =
    urlParams["pwa"] != "0" && "serviceWorker" in navigator && (urlParams["offline"] == "1" || /.*\.diagrams\.net$/.test(window.location.hostname) || /.*\.draw\.io$/.test(window.location.hostname));
  ...
  (function () {
    ...
    RoughCanvas.prototype.getStyle = function (stroke, fill) {
      ...
      if (fillStyle == "auto") {
        var bg = mxUtils.hex2rgb(this.shape.state != null ? this.shape.state.view.graph.shapeBackgroundColor : Editor.isDarkMode() ? Editor.darkColor : "#ffffff");
        fillStyle = style.fill != null && (gradient != null || (bg != null && style.fill == bg)) ? "solid" : defs["fillStyle"];
      }
      ...
      window.MathJax =
        config != null
          ...
          : {
              ...
              loader: {
                load: [urlParams["math-output"] == "html" ? "output/chtml" : "output/svg", "input/tex", "input/asciimath"],
              },
              startup: {
                pageReady: function () {
  ...
  Editor.prototype.getProxiedUrl = function (url) {
    if ((/test\.draw\.io$/.test(window.location.hostname) || /app\.diagrams\.net$/.test(window.location.hostname)) && !this.isCorsEnabledForUrl(url)) {
      var isVisioFilename = /(\.v(dx|sdx?))($|\?)/i.test(url) || /(\.vs(x|sx?))($|\?)/i.test(url);
            ...
            if (req.getStatus() >= 200 && req.getStatus() <= 299) {
              if (success != null) {
                ...
                if (binary) {
                  ...
                  if ((document.documentMode == 9 || document.documentMode == 10) && typeof window.mxUtilsBinaryToArray !== "undefined") {
  ...
  Editor.prototype.addFontCss = function (svgRoot, fontCss) {
    ...
    if (fontCss != null) {
      ...
      if (defs.length == 0) {
        defsElt = svgDoc.createElementNS != null ? svgDoc.createElementNS(mxConstants.NS_SVG, "defs") : svgDoc.createElement("defs");
  ...
  Editor.prototype.exportToCanvas = function (
    ...
    try {
      ...
      this.convertImages(
        graph.getSvg(null, null, border, noCrop, null, ignoreSelection, null, null, null, addShadow, null, keepTheme, exportType, cells),
  ...
  if (window.StyleFormatPanel != null) {
    ...
    mxCellRenderer.defaultShapes["process"].prototype.customProperties = [{ name: "size", dispName: "Indent", type: "float", min: 0, max: 0.5, defVal: 0.1 }];
    ...
    mxCellRenderer.defaultShapes["triangle"].prototype.customProperties = [{ name: "arcSize", dispName: "Arc Size", type: "float", min: 0, defVal: mxConstants.LINE_ARCSIZE }];

    mxCellRenderer.defaultShapes["document"].prototype.customProperties = [{ name: "size", dispName: "Size", type: "float", defVal: 0.3, min: 0, max: 1 }];
    ...
    mxCellRenderer.defaultShapes["tape"].prototype.customProperties = [{ name: "size", dispName: "Size", type: "float", min: 0, max: 1, defVal: 0.4 }];
    ...
    mxCellRenderer.defaultShapes["image"].prototype.customProperties = [{ name: "imageAspect", dispName: "Fixed Image Aspect", type: "bool", defVal: true }];
    ...
    mxCellRenderer.defaultShapes["dataStorage"].prototype.customProperties = [{ name: "size", dispName: "Size", type: "float", min: 0, max: 1, defVal: 0.1 }];
    ...
    mxCellRenderer.defaultShapes["display"].prototype.customProperties = [{ name: "size", dispName: "Size", type: "float", min: 0, max: 1, defVal: 0.25 }];
    ...
    mxCellRenderer.defaultShapes["cross"].prototype.customProperties = [{ name: "size", dispName: "Size", type: "float", min: 0, max: 1, defVal: 0.2 }];
    ...
    StyleFormatPanel.prototype.addProperties = function (div, properties, state) {
      ...
      function applyStyleVal(pName, newVal, prop, delIndex) {
        ...
        try {
          ...
          if (prop.index != null) {
            ...
            if (prop.size != null && allVals.length > prop.size) {
      ...
      for (var key in properties) {
        ...
        var pValue = state.style[key] != null ? mxUtils.htmlEntities(state.style[key] + "") : prop.getDefaultValue != null ? prop.getDefaultValue(state, this) : prop.defVal; //or undefined if defVal is undefined

        if (prop.type == "separator") {
          flipBkg = !flipBkg;
          continue;
        } else if (prop.type == "staticArr") {
    ...
    StyleFormatPanel.prototype.addStyles = function (div) {
                  ...
                  if (colorset != null) {
                    if (!mxEvent.isShiftDown(evt)) {
                      if (colorset["fill"] == "") {
                        ...
                        style = mxUtils.setStyle(style, mxConstants.STYLE_FILLCOLOR, colorset["fill"] || mxUtils.getValue(defaults, mxConstants.STYLE_FILLCOLOR, null));
                      }

                      style = mxUtils.setStyle(style, mxConstants.STYLE_GRADIENTCOLOR, colorset["gradient"] || mxUtils.getValue(defaults, mxConstants.STYLE_GRADIENTCOLOR, null));

                      if (!mxEvent.isControlDown(evt) && (!mxClient.IS_MAC || !mxEvent.isMetaDown(evt)) && graph.getModel().isVertex(cells[i])) {
                        style = mxUtils.setStyle(style, mxConstants.STYLE_FONTCOLOR, colorset["font"] || mxUtils.getValue(defaults, mxConstants.STYLE_FONTCOLOR, null));
                      }
                    }
                    ...
                    if (!mxEvent.isAltDown(evt)) {
                      if (colorset["stroke"] == "") {
                        ...
                        style = mxUtils.setStyle(style, mxConstants.STYLE_STROKECOLOR, colorset["stroke"] || mxUtils.getValue(defaults, mxConstants.STYLE_STROKECOLOR, null));
                      }
                    }
                  } else {
                    style = mxUtils.setStyle(style, mxConstants.STYLE_FILLCOLOR, mxUtils.getValue(defaults, mxConstants.STYLE_FILLCOLOR, "#ffffff"));
                    style = mxUtils.setStyle(style, mxConstants.STYLE_STROKECOLOR, mxUtils.getValue(defaults, mxConstants.STYLE_STROKECOLOR, "#000000"));
                    style = mxUtils.setStyle(style, mxConstants.STYLE_GRADIENTCOLOR, mxUtils.getValue(defaults, mxConstants.STYLE_GRADIENTCOLOR, null));

                    if (graph.getModel().isVertex(cells[i])) {
                      style = mxUtils.setStyle(style, mxConstants.STYLE_FONTCOLOR, mxUtils.getValue(defaults, mxConstants.STYLE_FONTCOLOR, null));
                    }
                  }
          ...
          if (colorset != null) {
            ...
            if (colorset["gradient"] != null) {
              if (mxClient.IS_IE && document.documentMode < 10) {
                btn.style.filter = "progid:DXImageTransform.Microsoft.Gradient(" + "StartColorStr='" + colorset["fill"] + "', EndColorStr='" + colorset["gradient"] + "', GradientType=0)";
              } else {
                btn.style.backgroundImage = "linear-gradient(" + colorset["fill"] + " 0px," + colorset["gradient"] + " 100%)";
              }
            } else if (colorset["fill"] == mxConstants.NONE) {
              btn.style.background = "url('" + Dialog.prototype.noColorImage + "')";
            } else if (colorset["fill"] == "") {
              btn.style.backgroundColor = mxUtils.getValue(graph.defaultVertexStyle, mxConstants.STYLE_FILLCOLOR, Editor.isDarkMode() ? Editor.darkColor : "#ffffff");
            } else {
              btn.style.backgroundColor = colorset["fill"] || mxUtils.getValue(graph.defaultVertexStyle, mxConstants.STYLE_FILLCOLOR, Editor.isDarkMode() ? Editor.darkColor : "#ffffff");
            }

            if (colorset["stroke"] == mxConstants.NONE) {
              btn.style.border = b + " transparent";
            } else if (colorset["stroke"] == "") {
              btn.style.border = b + " " + mxUtils.getValue(graph.defaultVertexStyle, mxConstants.STYLE_STROKECOLOR, !Editor.isDarkMode() ? Editor.darkColor : "#ffffff");
            } else {
              btn.style.border = b + " " + (colorset["stroke"] || mxUtils.getValue(graph.defaultVertexStyle, mxConstants.STYLE_STROKECOLOR, !Editor.isDarkMode() ? Editor.darkColor : "#ffffff"));
            }
      ...
      left.style.cssText =
        "position:absolute;left:10px;top:8px;bottom:" +
        bottom +
        "px;width:20px;margin:4px;opacity:0.5;" +
      ...
      right.style.cssText =
        "position:absolute;left:202px;top:8px;bottom:" +
        bottom +
        "px;width:20px;margin:4px;opacity:0.5;" +
  ...
  Graph.prototype.getSvg = function (background, scale, border, nocrop, crisp, ignoreSelection, showText, imgExport, linkTarget, hasShadow, incExtFonts, keepTheme, exportType, cells) {
    var temp = null;
    var tempFg = null;
    var tempBg = null;
    ...
    if (!keepTheme && this.themes != null && this.defaultThemeName == "darkTheme") {
      ...
      this.shapeForegroundColor = this.defaultThemeName == "darkTheme" ? "#000000" : Editor.lightColor;
      this.shapeBackgroundColor = this.defaultThemeName == "darkTheme" ? "#ffffff" : Editor.darkColor;
  ...
  mxGraphView.prototype.redrawEnumerationState = function (state) {
    ...
    if (shape != null) {
      ...
      var bounds = this.graph.model.isVertex(state.cell) ? new mxRectangle(state.x + state.width - 4 * s, state.y + 4 * s, 0, 0) : mxRectangle.fromPoint(state.view.getPoint(state));
  ...
  mxGraphView.prototype.validateBackgroundPage = function () {
    ...
    if (mxClient.IS_GC && this.getDrawPane() != null) {
      ...
      if (this.graph.mathEnabled && !mxClient.NO_FO && (this.webKitForceRepaintNode == null || this.webKitForceRepaintNode.parentNode == null) && this.graph.container.firstChild.nodeName == "svg") {
        ...
        (!this.graph.mathEnabled || (this.graph.container.firstChild.nodeName != "svg" && this.graph.container.firstChild != this.webKitForceRepaintNode))
      ) {
      ...
      var executeNextAction = mxUtils.bind(this, function () {
        if (index < actions.length) {
          ...
          if (action.toggleStyle != null && action.toggleStyle.key != null) {
            beginUpdate();
            this.toggleCellStyles(action.toggleStyle.key, action.toggleStyle.defaultValue != null ? action.toggleStyle.defaultValue : "0", this.getCellsForAction(action.toggleStyle, true));
          }
  ...
  Graph.prototype.addSvgShadow = function (svgRoot, group, createOnly, extend) {
    ...
    var filter = svgDoc.createElementNS != null ? svgDoc.createElementNS(mxConstants.NS_SVG, "filter") : svgDoc.createElement("filter");
    filter.setAttribute("id", this.shadowId);

    var blur = svgDoc.createElementNS != null ? svgDoc.createElementNS(mxConstants.NS_SVG, "feGaussianBlur") : svgDoc.createElement("feGaussianBlur");
    blur.setAttribute("in", "SourceAlpha");
    blur.setAttribute("stdDeviation", this.svgShadowBlur);
    blur.setAttribute("result", "blur");
    filter.appendChild(blur);

    var offset = svgDoc.createElementNS != null ? svgDoc.createElementNS(mxConstants.NS_SVG, "feOffset") : svgDoc.createElement("feOffset");
    ...
    var flood = svgDoc.createElementNS != null ? svgDoc.createElementNS(mxConstants.NS_SVG, "feFlood") : svgDoc.createElement("feFlood");
    ...
    var composite = svgDoc.createElementNS != null ? svgDoc.createElementNS(mxConstants.NS_SVG, "feComposite") : svgDoc.createElement("feComposite");
    ...
    var feBlend = svgDoc.createElementNS != null ? svgDoc.createElementNS(mxConstants.NS_SVG, "feBlend") : svgDoc.createElement("feBlend");
  ...
  PrintDialog.prototype.create = function (editorUi, titleText) {
    ...
    var accessor = PageSetupDialog.addPageFormatPanel(span, "printdialog", editorUi.editor.graph.pageFormat || mxConstants.PAGE_FORMAT_A4_PORTRAIT);
    pageScaleSection.appendChild(span);
    ...
    function preview(print) {
      ...
      function printGraph(thisGraph, pv, forcePageBreaks) {
        ...
        if (autoOrigin) {
          ...
          scale = Math.min((pf.height * v) / (gb.height / thisGraph.view.scale), (pf.width * h) / (gb.width / thisGraph.view.scale));
        } else {
        ...
        if (pv == null) {
          ...
          pv.writeHead = function (doc) {
            ...
            for (var i = 0; i < extFonts.length; i++) {
              ...
              if (Graph.isCssFontUrl(fontUrl)) {
                doc.writeln('<link rel="stylesheet" href="' + mxUtils.htmlEntities(fontUrl) + '" charset="UTF-8" type="text/css">');
              } else {
                doc.writeln('<style type="text/css">');
          ...
          if (pv.wnd != null) {
            for (var i = 0; i < extFonts.length; i++) {
              ...
              if (Graph.isCssFontUrl(fontUrl)) {
                pv.wnd.document.writeln('<link rel="stylesheet" href="' + mxUtils.htmlEntities(fontUrl) + '" charset="UTF-8" type="text/css">');
              } else {
      ...
      if (EditorUi.isElectronApp) {
        PrintDialog.electronPrint(
          editorUi,
          allPagesRadio.checked,
          pagesFrom,
          pagesTo,
          fitRadio.checked,
          sheetsAcrossInput.value,
          sheetsDownInput.value,
          parseInt(zoomInput.value) / 100,
          parseInt(pageScaleInput.value) / 100,
          accessor.get()
        );
      ...
      if (ignorePages) {
        ignorePages = selectionOnlyRadio.checked || (pagesFrom == currentPage && pagesTo == currentPage);
      }
        ...
        for (var i = i0; i <= imax; i++) {
          ...
          if (tempGraph == null) {
            ...
            if (bgImage != null && bgImage.originalSrc != null) {
              bgImage = editorUi.createImageForPageLink(bgImage.originalSrc, page);
            }

            tempGraph.background = bg;
            tempGraph.backgroundImage = bgImage != null ? new mxImage(bgImage.src, bgImage.width, bgImage.height, bgImage.x, bgImage.y) : null;
